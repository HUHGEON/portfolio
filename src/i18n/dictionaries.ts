...
const heogeon: Dictionary = {
  ...
  home: {
    ...
    featuredProjects: [
      ...
      },
      {
        ...
        highlights: [
          "미디어 추론 백엔드(Node·ffmpeg·외부 AI 추론)와 Streamlit 데이터 분석·시각화 대시보드 2종을 개발했습니다.",
  ...
  projects: [
    ...
    },
    {
      ...
      description:
        "엠트리센 인턴 중 수행한 사내 실무 3건을 기술 중심으로 정리했습니다. 미디어 추론 백엔드(Node.js·Express·fluent-ffmpeg·외부 AI 추론·MongoDB·Redis)와 데이터 분석·시각화 대시보드 2종(Python·Streamlit·pandas·matplotlib/Altair)을 개발하고, 자체 프로젝트를 테스트로 검증했습니다. 또한 사내에서 타사 앱을 직접 테스트하고 테스트 보고서로 정리·보고하는 QA 업무도 자주 수행했습니다. (도메인·세부 기능·정량 성과는 대외비)",
      href: "",
      stack: [
        "Node.js",
        "Express",
